        ...
        public void shouldReturnAllAssociatedEvents() {
                Event e1 = eventRepository
                                .save(new Event("Euniverse", "Park Eun Bin fan meeting",
                                                ...
                                                Instant.parse("2026-09-10T14:30:00+10:00"), "Park Eun Bin",
                                                EventStatus.PUBLISHED, venue));
                Event e2 = eventRepository.save(new Event("NewJeans Encore", null,
                                Instant.parse("2026-08-10T14:30:00+10:00"),
                                Instant.parse("2026-08-10T14:30:00+10:00"), null, EventStatus.DRAFT, venue));

                Event e3 = eventRepository
                                .save(new Event("League of Legends World Final", null,
                                                Instant.parse("2026-08-10T14:30:00+10:00"),
                                                Instant.parse("2026-08-10T14:30:00+10:00"), null, EventStatus.COMPLETED,
                                                venue));
                ...
                assertThat(summary)
                                ...
                                .contains(
                                                tuple("Euniverse", "Park Eun Bin fan meeting", e1.getStartsAt(),
                                                                e1.getEndsAt(), "Park Eun Bin",
                                                                EventStatus.PUBLISHED),
                                                tuple("NewJeans Encore", null, e2.getStartsAt(), e2.getEndsAt(), null,
                                                                EventStatus.DRAFT),
                                                tuple("League of Legends World Final", null, e3.getStartsAt(),
                                                                e3.getEndsAt(), null,
