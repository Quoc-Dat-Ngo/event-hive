...
public class PaymentIntegrationTest extends AbstractWebIntegrationTest {
    ...
    private String createUser() throws Exception {
        return extractIdFromMockMvc("/api/v1/users", """
                {
                    "firstName": "Kevin",
                    "lastName": "Ngo",
    ...
    private String createBooking(String userId, String eventId, String seatId) throws Exception {
        return extractIdFromMockMvc("/api/v1/bookings", String.format("""
                {
                    "priceCents": 20000,
                    "status": "PENDING",
                    "userId": "%s",
    ...
    void shouldCreatePaymentAndReturnAssociatedBookingSummary() throws Exception {
        ...
        String bookingId = createBooking(userId, eventId, seatId);
    ...
    void shouldReturnNotFoundWhenBookingDoesNotExistOnPaymentCreation() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/payments")
                ...
                .andExpect(jsonPath("$.message").value("Booking associated with this payment not found " + bookingId));
    }
    ...
    void shouldReturnBadRequestWhenPaymentCurrencyIsInvalid() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/payments")
                ...
                .andExpect(jsonPath("$.path").value("/api/v1/payments"))
                .andExpect(jsonPath("$.message").value(containsString("currency: size must be between 3 and 3")));
    }
}
